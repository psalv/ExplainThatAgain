...
class DeleteClass extends React.Component {
    ...
    success(user) {
        console.log("Removed class", user);
        this.props.router.replace("/");
    }

    readError(error) {
        console.log("Failed to remove class", error);
    ...
    render () {
        ...
        return (
            ...
            <div className="col-sm-4 col-sm-offset-4">
                ...
                <UserForm submitLabel="Remove Class" onSubmit={this.deleteClass} ref={ (ref) => this.form = ref }/>
            </div>
        )
    }
